...
- TROPOMI Level 2 methane products (NetCDF)
- Sentinel-2 Level 2A surface reflectance (JPEG2000 tiles)
- Sentinel-1 Ground Range Detected coherence (GeoTIFF)
- Pipeline right-of-way (ROW) geometry (WKT LineString)
...
- Calculate per-tile baselines (30-day rolling statistics)
- Compute z-scores for each sensor
- Generate composite leak score (weighted combination)
- Rank tiles for daily inspection priority
